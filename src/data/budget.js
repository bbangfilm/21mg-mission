...
// ⚠️ 지출의 식사·수영장 행은 아직 옛 44명 기준 — 최종 인원 확인 후 갱신 예정(잔액은 잠정치).
export const budget = {
  income: [
  ...
  balance: 930000, // 잠정 예비비 = 3,000,000 − 2,070,000 (지출 재산정 전)

  headcountNote:
    '회비는 참가 53명 기준 (성인 28 · 취학 19 · 미취학 6).',
  notes: [
    '⚠️ 식사·수영장 지출은 최종 인원 확인 후 갱신 예정 — 위 잔액은 잠정치입니다.',
    '회비는 식사·수영장·시설 등 공동 운영비. 숙소(유스호스텔)는 회비와 별도 — 가정별로 걷어 한꺼번에 납부.',
